...
object PrayerDhikrData {
    ...
    val listDataQauliyah: List<PrayerDhikrItem> by lazy {
        descQauliyah.zip(lafazQauliyah).zip(terjemahQauliyah).map {
    ...
    val listDataDzikir: List<PrayerDhikrItem> by lazy {
        descDzikir.zip(lafazDzikir).zip(terjemahDzikir).map {
            val desc = it.first.first
            val lafadz = it.first.second
            val translation = it.second
    ...
    val listDataDzikirPagi: List<PrayerDhikrItem> by lazy {
        descDzikirPagi.zip(lafazDzikirPagi).zip(terjemahDzikirPagi).map {
            val desc = it.first.first
            val lafadz = it.first.second
            val translation = it.second
    ...
    val listDataDzikirPetang: List<PrayerDhikrItem> by lazy {
        descDzikirPetang.zip(lafazDzikirPetang).zip(terjemahDzikirPetang).map {
            val desc = it.first.first
            val lafadz = it.first.second
            val translation = it.second
